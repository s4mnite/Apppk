  ...
  return <div>
    <style>{`
      @media (max-width: 480px) {
        .huevos-cat-grid3 { grid-template-columns: repeat(3, minmax(0,1fr)) !important; gap: 6px !important; }
        .huevos-cat-grid3 p:first-child { font-size: 9px !important; }
        .huevos-cat-grid3 p:last-child { font-size: 15px !important; }
        .huevos-cat-grid2 { grid-template-columns: 1fr !important; gap: 4px !important; }
        .huevos-week-strip button { min-width: 46px !important; padding: 6px 2px !important; }
        .huevos-two-col { grid-template-columns: 1fr !important; gap: 10px !important; }
        .huevos-lot-grid { grid-template-columns: repeat(2, minmax(0,1fr)) !important; }
        .huevos-modal-3col { grid-template-columns: repeat(3, minmax(0,1fr)) !important; gap: 6px !important; }
        .huevos-modal-2col { grid-template-columns: 1fr 1fr !important; gap: 8px !important; }
      }
      @media (max-width: 360px) {
        .huevos-modal-3col { grid-template-columns: 1fr !important; }
      }
    `}</style>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(260px,1fr))", gap:14 }}>
              {items.map(g => {
                ...
                >
                  ...
                  <div className="huevos-cat-grid3" style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:8, marginBottom:14 }}>
                  ...
                  <div className="huevos-cat-grid2" style={{ borderTop:`1px solid ${borderColor}`, paddingTop:12, display:"grid", gridTemplateColumns:"repeat(2,1fr)", gap:8 }}>
    ...
    {tab === "lotes" && <div style={{display:"grid",gap:14}}>
      {eggLots.length===0 ? <div style={card}><div style={{textAlign:"center",padding:36,color:textMuted}}>Todavía no hay lotes registrados. Las nuevas entradas aparecerán separadas por fecha.</div></div> : eggLots.map(lot=>{
        ...
        return <div key={lot.id} style={card} className="card-hover">
          ...
          <div className="huevos-lot-grid" style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(125px,1fr))",gap:9}}>
            {[
    ...
    {tab === "movimientos" && <>
      <div style={{...card, marginBottom:14}}>
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          ...
          <div className="huevos-week-strip" style={{flex:1,display:"grid",gridTemplateColumns:"repeat(7,minmax(50px,1fr))",gap:6,overflowX:"auto",paddingBottom:2}}>
    ...
    {tab === "balance" && <>
      ...
      <div style={{ ...card, marginBottom:16 }}>
        <div className="huevos-two-col" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:16 }}>
          <div>
